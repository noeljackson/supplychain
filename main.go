...
//
//go:embed iocs/persistence-paths.txt iocs/payload-filenames.txt iocs/packages.txt iocs/c2-domains.txt iocs/dead-drop-signatures.txt iocs/blocked-package-names.txt iocs/manifest.json
